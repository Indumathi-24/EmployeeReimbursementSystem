...
public class AllApprovedRequestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h3>Approved Requests Of All Employees</h3>");
		EmployeeReimbursementService reimbursementRequest = new EmployeeReimbursementServiceImpl();
		List<EmployeeReimbursementEntity> allApprovedList =reimbursementRequest.viewAllApprovedRequests();
		System.out.println(allApprovedList);
		for(EmployeeReimbursementEntity r: allApprovedList)
		{
		...
		for(EmployeeReimbursementEntity elist :allApprovedList)
		{
