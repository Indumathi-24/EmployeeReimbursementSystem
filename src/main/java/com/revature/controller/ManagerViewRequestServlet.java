...
public class ManagerViewRequestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<caption>Request Details of all Employees</caption>");
		...
		List<EmployeeReimbursementEntity> requestDetailsList=requestService.getRequestDetails(rId);
		...
		out.println("<form action='http://localhost:8080/EmployeeReimbursementSystem/ManagerUpdateRequest' method='GET'>");
		...
		for(EmployeeReimbursementEntity re : requestDetailsList)
		{
			...
			out.println("<th>Manager View </th>");
